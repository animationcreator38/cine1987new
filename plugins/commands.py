...
async def start(client, message):
    ...
    if data.startswith("sendfiles"):
        ...
        text=f"<b>📕Nᴀᴍᴇ ➠ : <code>{file_name}</code> \n\n🔗Sɪᴢᴇ ➠ : {get_size(file_size)}\n\n📂Fɪʟᴇ ʟɪɴᴋ ➠ : {g}\n\n<i>Note: This message is deleted in 20 mins to avoid copyrights. Save the link to Somewhere else okay</i></b>"
        if PREMIUM_AND_REFERAL_MODE == True:
    ...
    if not files_:
        ...
        try:
            ...
            btn = [[InlineKeyboardButton("🤚 Gᴇᴛ Fɪʟᴇ Bᴀᴄᴋ 🤚", callback_data=f'del#{file_id}')]]
            k = await msg.reply(text=f"<blockquote><b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ, ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ɪɴ 𝟭𝟬 ⏳ ᴍɪɴᴜᴛᴇꜱ. ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴛᴏ ᴀ ꜰʀɪᴇɴᴅ ⏩ ᴏʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇ ꜰᴏʟᴅᴇʀ. ᴛʜᴇɴ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ⚡ ᴛʜᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ᴛʜᴇʀᴇ. ᴛʜᴇɴ ᴛʜᴇ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴛʜᴇʀᴇ. \n\nकॉपीराइट के कारण यह मूवी फ़ाइल 𝟭𝟬 ⏳ मिनट में ऑटोमैटिक डिलीट हो जायेगी कृपया इस मूवी फ़ाइल को किसी फ्रैंड ⏩ या Saved Message folder में forward करे । फिर वहां से मूवी डाउनलोड ⚡ करना शुरू करें। फिर वहा पर मूवी फाइल ऑटोमैटिक डिलीट नही होगी ।</i></b></blockquote>")
            await asyncio.sleep(600)
            await msg.delete()
            await k.edit_text("<b>ɴᴏᴡ ᴛʜᴇ ᴛɪᴍᴇ ɪꜱ ᴏᴠᴇʀ ⌛, ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ꜰɪʟᴇ ʙᴀᴄᴋ ᴛʜᴇɴ ᴄʟɪᴄᴋ ᴏɴ ɢᴇᴛ ꜰɪʟᴇ ʙᴀᴄᴋ ʙᴜᴛᴛᴏɴ ✨</b>",reply_markup=InlineKeyboardMarkup(btn))
            return
        except:
            pass
...
@Client.on_message(filters.command("setlinkoff"))
...
@Client.on_message(filters.command("addtutorial"))
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        return await message.reply("<b>You entered Incorrect Format\n\nFormat: /addtutorial your tutorial link</b>")
...
async def check_plans_cmd(client, message):
    ...
    if await db.has_premium_access(user_id):         
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        m=await message.reply_text(f"**😢 You Don't Have Any Premium Subscription.\n\n Check Out Our Premium /plan**",reply_markup=reply_markup)
