...
PICS = (environ.get('PICS', 'https://envs.sh/w89.png')).split()
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002411258478').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002411258478'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002345014125').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '@+9-dJ1q67weZlOGNl')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002148997486')).split()]  # For Multiple Id Use One Space Between Each.
...
REFERAL_PREMEIUM_TIME = environ.get('REFERAL_PREMEIUM_TIME', '10day') # time in week, day, month.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+9-dJ1q67weZlOGNl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/how_to_download_mo_vie')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+9-dJ1q67weZlOGNl') # Support Chat Link Without https:// or @
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_download_mo_vie/34') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://civic-theressa-kria-46ea6f72.koyeb.app/")
