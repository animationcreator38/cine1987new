...
👨‍💻 Cᴏᴍᴍᴀɴᴅ : /clone</b>"""
    ...
    SUBSCRIPTION_TXT = """
<b>ʀᴇғғᴇʀ ᴛʜɪs ʟɪɴᴋ ᴛᴏ ʏᴏᴜʀ ғʀɪᴇɴᴅs, ғᴀᴍɪʟʏ, ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ғʀᴇᴇ ᴄɪɴᴇᴡᴡᴏᴅ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ғᴏʀ {}

--- ʏᴏᴜʀ ʀᴇғғᴇʀᴀʟ ʟɪɴᴋ ---
https://telegram.me/{}?start=cinewood-{}

ɪғ {}  ᴜsᴇʀ sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ᴡɪᴛʜ ʏᴏᴜʀ ʀᴇғғʀᴀʟ ʟɪɴᴋ ᴛʜᴇɴ ʏᴏᴜ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴀᴅᴅᴇᴅ ɪɴ ᴄɪɴᴇᴡᴏᴏᴅ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ᴜsᴇʀs ʟɪsᴛ ᴛʜᴀɴ ʏᴏᴜ ʜᴀᴠᴇ ғᴜʟʟ ᴀᴄᴄᴇss ᴏғ ᴄɪɴᴇᴡᴏᴏᴅ sᴜʙsᴄʀɪᴘᴛɪᴏɴ.

ᴛᴏ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴄᴜʀʀᴇɴᴛ ᴘʟᴀɴ sᴛᴀᴛᴜs
 ᴛʏᴘᴇ /myplan ᴏʀ ᴘʟᴀɴʟɪsᴛ ᴛʏᴘᴇ /plan 🪄.</b>"""
...
тᴏ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴄᴜʀʀᴇɴᴛ ᴘʟᴀɴ ꜱᴛᴀᴛᴜꜱ ᴛʏᴘᴇ  /myplan 💗"""
